<?php
// dashboard/registrar.php - UPDATED VERSION
...
try {
    ...
    <!-- Response Modal -->
    <div id="response-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(44, 62, 80, 0.8); z-index: 1000;">
        <div style="background: white; width: 90%; max-width: 600px; margin: 5% auto; padding: 2rem; box-shadow: 0 20px 60px rgba(0,0,0,0.3);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid #e9ecef;">
                <h3 style="color: #2c3e50; font-size: 1.5rem; font-weight: 700;">Απάντηση σε Ερώτηση</h3>
                <button onclick="closeModal('response-modal')" style="background: none; border: none; font-size: 1.5rem; cursor: pointer; color: #7f8c8d; padding: 0.5rem;">&times;</button>
            </div>

            <div id="question-details" style="background-color: #f8f9fa; padding: 1rem; margin-bottom: 1.5rem;">
            ...
            <form id="response-form">
                ...
                <div style="margin-bottom: 1.5rem;">
                    <label style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #2c3e50;">Η Απάντησή Σας</label>
                    <textarea id="response-text" name="response" placeholder="Γράψτε την απάντησή σας..." required style="width: 100%; padding: 0.875rem; border: 1px solid #bdc3c7; font-size: 1rem; min-height: 120px; resize: vertical;"></textarea>
                </div>
                ...
                <div style="display: flex; gap: 1rem; justify-content: flex-end;">
                    ...
                    <button type="submit" class="btn btn-primary">Αποστολή Απάντησης</button>
                </div>
            </form>
        </div>
    </div>
